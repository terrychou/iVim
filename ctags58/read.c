...
*/
#ifdef IOS_FUNCTION
static void ctags_restore_file(void);
#endif
...
static void ctags_restore_file(void) {
    ...
    File.source.name = NULL;
    File.source.tagPath = NULL;
    File.source.lineNumber = 0;
    File.source.isHeader = FALSE;
    File.source.language = 0;
}
#endif
/*
