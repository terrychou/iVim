...
EXCMD(CMD_iabclear,	"iabclear",	ex_abclear,
	...
	ADDR_NONE),
#ifdef FEAT_GUI_IOS
EXCMD(CMD_ictags,	"ictags",	ex_ios_cmds,
	EX_EXTRA|EX_CMDWIN|EX_FILES,
	ADDR_NONE),
EXCMD(CMD_ideletefont,	"ideletefont",	ex_ios_cmds,
	EX_EXTRA|EX_CMDWIN,
	ADDR_NONE),
EXCMD(CMD_idocuments,	"idocuments",	ex_ios_cmds,
	EX_EXTRA|EX_CMDWIN,
	ADDR_NONE),
#endif
EXCMD(CMD_if,		"if",		ex_if,
	...
	ADDR_NONE),
#ifdef FEAT_GUI_IOS
EXCMD(CMD_ifont,	"ifont",	ex_ios_cmds,
	EX_EXTRA|EX_CMDWIN,
	ADDR_NONE),
#endif
...
EXCMD(CMD_intro,	"intro",	ex_intro,
	...
	ADDR_NONE),
#ifdef FEAT_GUI_IOS
EXCMD(CMD_iolddocs,	"iolddocs",	ex_ios_cmds,
	EX_BANG|EX_EXTRA|EX_CMDWIN,
	ADDR_NONE),
EXCMD(CMD_iopenurl,	"iopenurl",	ex_ios_cmds,
	EX_EXTRA|EX_CMDWIN,
	ADDR_NONE),
#endif
EXCMD(CMD_isearch,	"isearch",	ex_findpat,
	...
	ADDR_LINES),
#ifdef FEAT_GUI_IOS
EXCMD(CMD_isetekbd,	"isetekbd",	ex_ios_cmds,
	EX_BANG|EX_EXTRA|EX_CMDWIN|EX_FILES,
	ADDR_NONE),
EXCMD(CMD_ishare,	"ishare",	ex_ios_cmds,
